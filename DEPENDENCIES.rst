...
#. Download the Cyclus Core Debian installation package corresponding to your
   ...
   <http://dory.fuelcycle.org:4848/ubuntu.14.04/cyclus_1.5.0.deb>`_ or
   `16.04
   <http://dory.fuelcycle.org:4848/ubuntu.16.04/cyclus_1.5.0.deb>`_).

#. Install the package by running:

   .. code-block:: bash 

     $ sudo dpkg -i cyclus_1.5.0.deb
