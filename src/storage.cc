...
void Storage::InitBuyPolicyParameters() {
  ...
  if (active_buying_frequency_type == "Fixed") {
    ...
    active_dist_ = cyclus::UniformIntDist>(new cyclus::UniformIntDist(active_buying_min, active_buying_max));
  }
    ...
    active_dist_ = cyclus::NormalIntDist>(new cyclus::NormalIntDist(active_buying_mean, active_buying_stddev, 
  ...
  if (dormant_buying_frequency_type == "Fixed") {
    ...
    dormant_dist_ = cyclus::UniformIntDist>(new cyclus::UniformIntDist(dormant_buying_min, dormant_buying_max));
  }
    ...
    dormant_dist_ = cyclus::NormalIntDist>(new cyclus::NormalIntDist(dormant_buying_mean, dormant_buying_stddev,
  ...
  if (buying_size_type == "Fixed") {
    size_dist_ = cyclus::FixedDoubleDist>(new cyclus::FixedDoubleDist(buying_size_val));
  }
    ...
    size_dist_ = cyclus::UniformDoubleDist>(new cyclus::UniformDoubleDist(buying_size_min, buying_size_max));
  }
