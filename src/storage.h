...
/// @class Storage
///
/// This Facility is intended to hold materials for a user specified amount of
/// time in order to model a storage facility with a certain residence time or
/// holdup time. The Storage class inherits from the Facility class and is
/// dynamically loaded by the Agent class when requested.
///
/// @section intro Introduction
/// This Agent was initially developed to support the fco code-to-code
/// comparison.
/// It's very similar to the "NullFacility" of years past. Its purpose is to hold
/// materials and release them only after some period of delay time.
///
/// @section agentparams Agent Parameters
/// in_commods is a vector of strings naming the commodities that this facility
/// receives out_commods is a string naming the commodity that in_commod is
/// stocks into residence_time is the minimum number of timesteps between
/// receiving and offering in_recipe (optional) describes the incoming resource
/// by recipe
///
/// @section optionalparams Optional Parameters
/// max_inv_size is the maximum capacity of the inventory storage throughput is
/// the maximum processing capacity per timestep
///
...
#pragma cyclus var {                               \
  ...
  "uilabel" : "Input Commodities", "uitype" :["oneormore", "incommodity"] }
...
#pragma cyclus var {                                                        \
  "default" : 0, "tooltip" : "residence time (timesteps)",                  \
  "doc" : "the minimum holding time for a received commodity (timesteps).", \
  "units" : "time steps", "uilabel" : "Residence Time" }
  int residence_time;
