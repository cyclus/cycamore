#ifndef CYCAMORE_SRC_DEPLOY_MANAGER_INST_H_
#define CYCAMORE_SRC_DEPLOY_MANAGER_INST_H_ 
...
class DeployManagerInst : public cyclus::Institution,
 ...
 public:
  DeployManagerInst(cyclus::Context* ctx);

  virtual ~DeployManagerInst();
...
#endif  // CYCAMORE_SRC_DEPLOY_MANAGER_INST_H_
