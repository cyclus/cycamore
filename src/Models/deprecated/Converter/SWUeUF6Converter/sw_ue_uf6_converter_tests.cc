...
TEST_F(SWUeUF6ConverterTest, CopyFreshModel) {
  ...
  EXPECT_NO_THROW(dynamic_cast<SWUeUF6Converter*>
                  (new_facility)); // still a stub facility
  EXPECT_NO_THROW(dynamic_cast<FakeSWUeUF6Converter*>
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
INSTANTIATE_TEST_CASE_P(SWUeUF6Conv, ConverterModelTests,
                        Values(&SWUeUF6ConverterConstructor));
INSTANTIATE_TEST_CASE_P(SWUeUF6Conv, ModelTests,
                        Values(&SWUeUF6ConverterModelConstructor));
