...
TEST_F(RecipeReactorTest, CopyFreshModel) {
  ...
  EXPECT_NO_THROW(dynamic_cast<RecipeReactor*>
                  (new_facility)); // still a recipe reactor
  EXPECT_NO_THROW(dynamic_cast<FakeRecipeReactor*>
                  (new_facility)); // still a fake recipe reactor
...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
INSTANTIATE_TEST_CASE_P(RecipeReactor, FacilityModelTests,
                        Values(&RecipeReactorConstructor));
INSTANTIATE_TEST_CASE_P(RecipeReactor, ModelTests,
                        Values(&RecipeReactorModelConstructor));
