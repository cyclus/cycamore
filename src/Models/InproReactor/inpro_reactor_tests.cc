...
//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
cyclus::Model* InproReactorModelConstructor(cyclus::Context* ctx) {
  using cycamore::InproReactor;
  return dynamic_cast<cyclus::Model*>(new InproReactor(ctx));
}

//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
cyclus::FacilityModel* InproReactorConstructor(cyclus::Context* ctx) {
  using cycamore::InproReactor;
  return dynamic_cast<cyclus::FacilityModel*>(new InproReactor(ctx));
}

//- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
INSTANTIATE_TEST_CASE_P(InproReactor, FacilityModelTests,
                        Values(&InproReactorConstructor));
INSTANTIATE_TEST_CASE_P(InproReactor, ModelTests,
                        Values(&InproReactorModelConstructor));
